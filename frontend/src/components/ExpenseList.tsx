...
const ExpenseList = ({ refreshSignal, showAll = false }: any) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="space-y-3">
        {displayExpenses.map((e: any) => {
          ...
          return (
            <div
              key={e.id}
              className="group relative bg-white dark:bg-slate-800/50 p-3 sm:p-4 rounded-2xl border border-slate-100 dark:border-slate-700 hover:border-indigo-500/30 hover:shadow-md transition-all duration-300"
            >
      ...
      {/* PORTAL: This moves the popup outside of this component 
        and attaches it directly to the <body> tag. 
      */}
      {editingExpense && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative w-full max-w-lg z-10 animate-fadeIn">
            <EditExpenseForm
